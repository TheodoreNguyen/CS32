...
public:
	StudentWorld(std::string assetDir) :
		GameWorld(assetDir), m_level(0), m_player(NULL), m_exit(NULL){}
	...
	void pushBackBullet(int startX, int startY, StudentWorld* wp, GraphObject::Direction dir);
	void vectorEraser(int position);
